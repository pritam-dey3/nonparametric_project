##this file contains all the code regarding savage statistic, 
## these functions should be compiled at 2nd step (this also contains compiling files of capon.R)
## 3rd step is to compile files of power_simulate.R
